...
// 点击进入章节
const handleClick = (value, chapterName) => {
  To("../editchapter/editChapter?chapterId=" + value + "&name=" + chapterName)
}
            ...
            chapterList.length == 0 ?
              ...
              chapterList.map(item => {
                return (
                  ...
                  >
                    {
                      <AtListItem title={item.name} onClick={handleClick.bind(this, item.id, item.name)} iconInfo={{ size: 25, color: '#E6B00F', value: 'clock', }} >
                      </AtListItem>
                    }
                  </AtSwipeAction>
                )
