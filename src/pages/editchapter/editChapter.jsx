...
const EditChapter = () => {
  ...
  useEffect(() => {
    const getData = async () => await getChapterTask(routerParams.chapterId)
    getData().then(res => {
  ...
  const tabList = [
    { title: '课程简介', component: <Introduction /> },
    { title: '课程习题', component: <ExamineList examineList={examineList} /> },
    { title: '课程资料', component: <Details /> },
    { title: '留言讨论', component: <Message /> }]
